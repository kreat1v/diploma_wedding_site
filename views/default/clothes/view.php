        ...
        <div class="product view-product">
            ...
            <div class="gradient-border">
                ...
                <div class="goods">
                    ...
                    <?php
                    $image = Config::get('clothesImgRoot') . $data['product']['id_clothes'] . DS . $data['galery'][0];
                    ...
                    <div class="blur <?=$blurClass?>">
                        <img src="<?=Config::get('clothesImg') . $data['product']['id_clothes'] . DS . $data['galery'][0]?>"/>
                    </div>
                    ...
                    <div class="bt">
                        <?php if(Session::get('id') && Session::get('role') == 'user'): ?>
                            ...
                            <form method="post">
                                <input class="id_products" type="hidden" name="id_products" value="<?=$data['product']['id_clothes']?>">
                            ...
                            <?php endif; ?>
                            <?php if(!in_array($data['product']['id_clothes'] . $data['category'], $data['favorites'])): ?>
                            <form method="post">
                                <input class="id_products" type="hidden" name="id_products" value="<?=$data['product']['id_clothes']?>">
                                <input class="category" type="hidden" name="category" value="<?=lcfirst($router->getController(true))?>">
                            ...
                            <?php endif; ?>
                        <?php endif; ?>
                        <a href="<?=$router->buildUri('clothes.reviews', [$data['product']['id_clothes']])?>" class="sm-buttons text">
                    ...
                    <div class="galery">
                        <div class="panels">
                            ...
                            <a href="<?=\App\Core\Config::get('clothesImg') . $data['product']['id_clothes'] . DS . $img?>" class="panel">
                                <div class="panel__content" style="background-image: url('<?=\App\Core\Config::get('clothesImgWeb') . $data['product']['id_clothes'] . '/' . $img?>');"></div>
                            </a>
                            <?php endforeach; ?>
                        </div>
                    </div>
                    ...
                    <div class="mob-gallery">
                        <?php foreach ($data['galery'] as $img): ?>
                        <a href="<?=\App\Core\Config::get('clothesImg') . $data['product']['id_clothes'] . DS . $img?>" style="background-image: url('<?=\App\Core\Config::get('clothesImgWeb') . $data['product']['id_clothes'] . '/' . $img?>');"></a>
                        <?php endforeach; ?>
                    </div>
