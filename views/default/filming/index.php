                    ...
                    <div class="goods">
                        ...
                        <div class="galery">
                            <div class="panels">
                                ...
                                <a href="<?=\App\Core\Config::get('filmingImg') . $value['id_filming'] . DS . $img?>" class="panel">
                        ...
                        <div class="mob-gallery">
                            <?php foreach ($value['galery'] as $img): ?>
                            <a href="<?=\App\Core\Config::get('filmingImg') . $value['id_filming'] . DS . $img?>" style="background-image: url('<?=\App\Core\Config::get('filmingImgWeb') . $value['id_filming'] . '/' . $img?>');"></a>
                            <?php endforeach; ?>
                        </div>
                    </div>
                ...
                <nav>
                    <ul class="pagination text">
                        <li class="<?=$data['pagination']['back'] ? '' : 'disabled'?>">
                            <a href="<?=$data['pagination']['back'] ? $router->buildUri('filming.index', [1]).$filter : ''?>">
                                <span>&laquo;</span>
                            </a>
                        </li>

                        <li class="<?=$data['pagination']['back'] ? '' : 'disabled'?>">
                            <a href="<?=$data['pagination']['back'] ? $router->buildUri('filming.index', [$data['pagination']['back']]).$filter : ''?>"><?=__('pagination.previous')?></a>
                        </li>

                        <?php foreach ($data['pagination']['middle'] as $key => $value): ?>
                        <li class="<?=$data['page'] == $key ? 'active' : ''?>">
                            <a href="<?=$router->buildUri('filming.index', [$key]).$filter?>"><?=$key?></a>
                        </li>
                        <?php endforeach; ?>

                        <li class="<?=$data['pagination']['forward'] ? '' : 'disabled'?>">
                            <a href="<?=$data['pagination']['forward'] ? $router->buildUri('filming.index', [$data['pagination']['forward']]).$filter : ''?>"><?=__('pagination.next')?></a>
                        </li>

                        <li class="<?=$data['pagination']['forward'] ? '' : 'disabled'?>">
                            <a href="<?=$router->buildUri('filming.index', [$data['pagination']['last']]).$filter?>">
                                <span>&raquo;</span>
                            </a>
                        </li>
                    </ul>
        ...
        <div class="filter text">
            ...
            <form method="get" id="filter">
                ...
                <div class="bt">
                    ...
                    <div>
                        <a class="sm-buttons text" href="<?=$router->buildUri('.filming')?>"><?=__('filter.reset')?></a>
                    </div>
                </div>
            </form>
        </div>
