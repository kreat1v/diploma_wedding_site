...
<div class="sections">
    ...
    <div class="container">
        ...
        <div class="filter text">
            <form method="get" id="filter-filming">
                ...
                <div class="bt">
                    ...
                    <div>
                        <a class="sm-buttons" href="<?=$router->buildUri('.filming')?>"><?=__('filter.reset')?></a>
                    </div>
                </div>
            </form>
        </div>
...
<script type="text/javascript" src="/js/filter-filming.js"></script>
