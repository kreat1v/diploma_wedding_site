...
<div class="sections">
    ...
    <div class="container">
            ...
            <?php if (!empty($data['product'])):
                ...
                <div class="gradient-border">
                    ...
                    <div class="goods">
                        ...
                        <?php
                        $image = Config::get('hotelImgRoot') . $value['id'] . DS . $value['galery'][0];
                        ...
                        <div class="blur <?=$blurClass?>">
                            <img src="<?=Config::get('hotelImg') . $value['id'] . DS . $value['galery'][0]?>"/>
                        </div>
                        ...
                        <div class="bt">
                            ...
                            <form method="post">
                                ...
                                <?php endif; ?>
                            <?php endif; ?>
                            <a href="<?=$router->buildUri('hotel.reviews', [$value['id']])?>" class="sm-buttons text">
                        ...
                        <div class="galery">
                            <div class="panels">
                                ...
                                <a href="javascript:void(0)" class="panel">
                                    <div class="panel__content" style="background-image: url('<?=\App\Core\Config::get('hotelImgWeb') . $value['id'] . '/' . $img?>');"></div>
                                </a>
                                <?php endforeach; ?>
                            </div>
                        </div>
        ...
        <div class="filter text">
            <form method="get" id="filter-hotel">
                ...
                <div class="bt">
                    ...
                    <div>
                        <a class="sm-buttons" href="<?=$router->buildUri('.hotel')?>"><?=__('filter.reset')?></a>
                    </div>
                </div>
            </form>
        </div>
...
<script type="text/javascript" src="/js/filter-hotel.js"></script>
