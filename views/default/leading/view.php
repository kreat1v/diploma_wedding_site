        ...
        <div class="product view-product">
            ...
            <div class="gradient-border">
                ...
                <div class="goods">
                    ...
                    <?php
                    $image = Config::get('leadingImgRoot') . $data['product']['id'] . DS . $data['galery'][0];
                    ...
                    <div class="blur <?=$blurClass?>">
                        <img src="<?=Config::get('leadingImg') . $data['product']['id'] . DS . $data['galery'][0]?>"/>
                    </div>
                    ...
                    <div class="bt">
                        ...
                        <form method="post">
                            ...
                            <?php endif; ?>
                        <?php endif; ?>
                        <a href="<?=$router->buildUri('leading.reviews', [$data['product']['id']])?>" class="sm-buttons text">
                    ...
                    <div class="galery">
                        <div class="panels">
                            ...
                            <a href="javascript:void(0)" class="panel">
                                <div class="panel__content" style="background-image: url('<?=\App\Core\Config::get('leadingImgWeb') . $data['product']['id'] . '/' . $img?>');"></div>
                            </a>
                            <?php endforeach; ?>
                        </div>
                    </div>
