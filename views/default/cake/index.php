                    ...
                    <div class="goods">
                        ...
                        <div class="bt">
                            <?php if(Session::get('id') && Session::get('role') == 'user'): ?>
                                <?php if(empty(Session::get('cart')['cake'])): ?>
                                <form method="post">
                        ...
                        <div class="galery">
                            <div class="panels">
                                ...
                                <a href="<?=\App\Core\Config::get('cakeImg') . $value['id_cake'] . DS . $img?>" class="panel">
                        ...
                        <div class="mob-gallery">
                            <?php foreach ($value['galery'] as $img): ?>
                            <a href="<?=\App\Core\Config::get('cakeImg') . $value['id_cake'] . DS . $img?>" style="background-image: url('<?=\App\Core\Config::get('cakeImgWeb') . $value['id_cake'] . '/' . $img?>');"></a>
                            <?php endforeach; ?>
                        </div>
                    </div>
        ...
        <div class="filter text">
            ...
            <form method="get" id="filter">
                ...
                <div class="bt">
                    ...
                    <div>
                        <a class="sm-buttons text" href="<?=$router->buildUri('.cake')?>"><?=__('filter.reset')?></a>
                    </div>
                </div>
            </form>
        </div>
