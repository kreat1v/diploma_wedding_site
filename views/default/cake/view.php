                ...
                <div class="goods">
                    ...
                    <div class="galery">
                        <div class="panels">
                            ...
                            <a href="<?=\App\Core\Config::get('cakeImg') . $data['product']['id_cake'] . DS . $img?>" class="panel">
                    ...
                    <div class="mob-gallery">
                        <?php foreach ($data['galery'] as $img): ?>
                        <a href="<?=\App\Core\Config::get('cakeImg') . $data['product']['id_cake'] . DS . $img?>" style="background-image: url('<?=\App\Core\Config::get('cakeImgWeb') . $data['product']['id_cake'] . '/' . $img?>');"></a>
                        <?php endforeach; ?>
                    </div>
