			...
			<header>
		        <div class="menu">
		            ...
		            <div class="right-side">
						...
						<div class="mob-login">
							<?php if($router->getController('true') != 'Login' && !$session_id): ?>
							<a href="<?=$router->buildUri('.login')?>">
		        ...
		        <div class="footer" class="menu">
		            <div class="menu-list">
		                <ul>
							...
							<?php if ($session_id && Session::get('role') == 'user'):?>
		                    <li><a href="<?=$router->buildUri('user.communications')?>"><?=__('footer.communications')?></a></li>
							<?php endif; ?>
			...
			<div>
				...
				<div id="bar-main">
					...
					<ul class="link text">
						...
						<li class="mob-search">
							<a href="<?=$router->buildUri('.search')?>"><?=__('bar-menu.search')?></a>
						</li>
						<li>
