...
<div class="container">
    <div class="category">
        ...
        <?php if (isset($data['product'])): ?>
            ...
            <div class="bt text">
                <a class="sm-buttons" href="<?=$router->buildUri('product.auto', ['new'])?>">
            ...
            <div class="table text">
    			<table>
    				...
    				<tr>
    					...
    					<td>
                            <a class="sm-buttons" href="<?=$router->buildUri('default.auto.view', [$value['id_auto']])?>">
                        ...
                        <?php endif; ?>
    					<td>
                            <a class="sm-buttons" href="<?=$router->buildUri('admin.product.auto', ['edit', $value['id_auto']])?>">
            ...
            <nav>
                <ul class="pagination text">
                    <li class="<?=$data['pagination']['back'] ? '' : 'disabled'?>">
                        <a href="<?=$data['pagination']['back'] ? $router->buildUri('admin.product.auto', [1]) : ''?>">
                            <span>&laquo;</span>
                        </a>
                    </li>

                    <li class="<?=$data['pagination']['back'] ? '' : 'disabled'?>">
                        <a href="<?=$data['pagination']['back'] ? $router->buildUri('admin.product.auto', [$data['pagination']['back']]) : ''?>"><?=__('pagination.previous')?></a>
                    </li>

                    <?php foreach ($data['pagination']['middle'] as $key => $value): ?>
                    <li class="<?=$data['page'] == $key ? 'active' : ''?>">
                        <a href="<?=$router->buildUri('admin.product.auto', [$key])?>"><?=$key?></a>
                    </li>
                    <?php endforeach; ?>

                    <li class="<?=$data['pagination']['forward'] ? '' : 'disabled'?>">
                        <a href="<?=$data['pagination']['forward'] ? $router->buildUri('admin.product.auto', [$data['pagination']['forward']]) : ''?>"><?=__('pagination.next')?></a>
                    </li>

                    <li class="<?=$data['pagination']['forward'] ? '' : 'disabled'?>">
                        <a href="<?=$router->buildUri('admin.product.auto', [$data['pagination']['last']])?>">
                            <span>&raquo;</span>
                        </a>
                    </li>
                </ul>
            ...
            <form class="form text" id="product-form" method="post" enctype="multipart/form-data">
                ...
                <fieldset>
                    ...
                    <label>
                        ...
                        <input class="input" id="brand" type="text" name="brand" value="<?=$edit ? htmlspecialchars($data['edit']['main']['brand']) : ''?>">
                        <div class="tooltips-left">
