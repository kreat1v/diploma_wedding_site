...
<div class="container">
    <div class="category">
        ...
        <?php if (isset($data['product'])): ?>
            ...
            <div class="bt text">
                <a class="sm-buttons" href="<?=$router->buildUri('product.cake', ['new'])?>">
            ...
            <div class="table text">
    			<table>
    				...
    				<tr>
    					...
    					<td>
                            <a class="sm-buttons" href="<?=$router->buildUri('default.cake.view', [$value['id_cake']])?>">
                        ...
                        <?php endif; ?>
    					<td>
                            <a class="sm-buttons" href="<?=$router->buildUri('admin.product.cake', ['edit', $value['id_cake']])?>">
            ...
            <nav>
                <ul class="pagination text">
                    <li class="<?=$data['pagination']['back'] ? '' : 'disabled'?>">
                        <a href="<?=$data['pagination']['back'] ? $router->buildUri('admin.product.cake', [1]) : ''?>">
                            <span>&laquo;</span>
                        </a>
                    </li>

                    <li class="<?=$data['pagination']['back'] ? '' : 'disabled'?>">
                        <a href="<?=$data['pagination']['back'] ? $router->buildUri('admin.product.cake', [$data['pagination']['back']]) : ''?>"><?=__('pagination.previous')?></a>
                    </li>

                    <?php foreach ($data['pagination']['middle'] as $key => $value): ?>
                    <li class="<?=$data['page'] == $key ? 'active' : ''?>">
                        <a href="<?=$router->buildUri('admin.product.cake', [$key])?>"><?=$key?></a>
                    </li>
                    <?php endforeach; ?>

                    <li class="<?=$data['pagination']['forward'] ? '' : 'disabled'?>">
                        <a href="<?=$data['pagination']['forward'] ? $router->buildUri('admin.product.cake', [$data['pagination']['forward']]) : ''?>"><?=__('pagination.next')?></a>
                    </li>

                    <li class="<?=$data['pagination']['forward'] ? '' : 'disabled'?>">
                        <a href="<?=$router->buildUri('admin.product.cake', [$data['pagination']['last']])?>">
                            <span>&raquo;</span>
                        </a>
                    </li>
                </ul>
                    ...
                    <div id="galery">
                        ...
                        <?php if(isset($data['edit']['galery']) && $data['edit']['galery'] != false): ?>
                            ...
                            <div class="file-upload"
                                ...
                                <img class="product-image" style="display: block;" src="<?=Config::get('cakeImg') . $data['edit']['main']['id'] . DS . $img?>" />
